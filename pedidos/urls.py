...
urlpatterns = [
    ...
    path('reporte/ubicacion/excel/', reporte_ubicacion_excel, name='reporte_ubicacion_excel'),
    path('dashboard/export_excel/', exportar_dashboard_excel, name='exportar_dashboard_excel'),
]